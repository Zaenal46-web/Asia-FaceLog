<x-app-layout>
    @include('layouts.partials.page-header', [
        'title' => 'Tambah Shift Master',
        'subtitle' => 'Tambahkan shift kerja baru sebagai pondasi rule absensi.'
    ])

    @include('layouts.partials.flash-message')

    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <form action="{{ route('master.shift-master.store') }}" method="POST" class="grid grid-cols-1 gap-6 md:grid-cols-2">
            @csrf
            ...
            <div class="space-y-4 md:col-span-2">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input type="checkbox" id="sabtu_aktif" name="sabtu_aktif" value="1" @checked(old('sabtu_aktif', 1))
                        class="h-5 w-5 rounded border-slate-300 text-blue-600 focus:ring-blue-500">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input type="checkbox" id="minggu_aktif" name="minggu_aktif" value="1" @checked(old('minggu_aktif'))
                        class="h-5 w-5 rounded border-slate-300 text-blue-600 focus:ring-blue-500">
